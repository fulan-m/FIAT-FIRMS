 ...
 * Works for both SNPP and NOAA-20.
 */
...
function processYear(startDate, endDate) {
  ...
  var viirs = ee.ImageCollection("NASA/LANCE/NOAA20_VIIRS/C2")
...
var processFeature = function (feature) {
  ...
  var exportDescription = 'NOAA20_' + year;
  
  Export.table.toDrive({
    collection: finalData,
    description: exportDescription,
    folder: 'ic-fiat_firms/NOAA20',
    fileFormat: 'CSV'
  });
  
  print('Export task created for NOAA-20 Year: ' + year);
}
